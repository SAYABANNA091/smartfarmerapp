            ...
            if (t) {
                if (-1 == e && (e = this[n ? "text" : "val"]().length), window.getSelection) n ? (t.focus(), window.getSelection().collapse(t.firstChild, e)) : t.setSelectionRange(e, e);
                    ...
                    if (n) {
                        ...
                        o.moveToElementText(t), o.moveStart("character", e), o.collapse(!0), o.select()
                    } else {
                        var o = t.createTextRange();
                        o.move("character", e), o.select()
                    } n || t.focus()
            }
            return this
        }
        if (t) {
            if (window.getSelection) {
                if (n) {
                    ...
                    var c = window.getSelection().getRangeAt(0),
                        r = c.cloneRange();
                    return r.selectNodeContents(t), r.setEnd(c.endContainer, c.endOffset), r.toString().length
                }
            ...
            if (document.selection) {
                if (t.focus(), n) {
                    ...
                    return r.moveToElementText(t), r.setEndPoint("EndToEnd", c), r.text.length
                }
                var e = 0,
                    o = t.createTextRange(),
                    r = document.selection.createRange().duplicate(),
                    a = r.getBookmark();
                for (o.moveToBookmark(a); 0 !== o.moveStart("character", -1);) e++;
                return e
            }
