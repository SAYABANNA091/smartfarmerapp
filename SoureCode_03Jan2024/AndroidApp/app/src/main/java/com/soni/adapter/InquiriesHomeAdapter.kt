...
class InquiriesHomeAdapter(val context: Context ,var list:ArrayList<PropertyModel>):
    RecyclerView.Adapter<InquiriesHomeAdapter.InquiriesHomeAdapterViewHoldes>() {
    ...
    override fun onBindViewHolder(holder: InquiriesHomeAdapterViewHoldes, position: Int) {
        ...
        wordtoSpan.setSpan(
            ...
            text.split(context.getString(R.string.about))[0].length+5+  text.split(context.getString(R.string.about))[1].length,
